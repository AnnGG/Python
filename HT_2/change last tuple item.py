...
list_of_tuple = [(10, 20, 40), (40, 50, 60, 70), (80, 90), (1000,)]

user_item = input("Input your item: ")

print("Your new list_of_tuple")
                  
print([tuple_item[:-1] + (user_item,) for tuple_item in list_of_tuple])
